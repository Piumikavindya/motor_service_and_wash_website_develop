...
const SignUpPage = () => {
  return (
    <div class="min-w-screen min-h-screen bg-gray-900 flex items-center justify-center  py-1">
      <div
        className="bg-gray-100 text-gray-500 rounded-3xl shadow-xl w-full overflow-hidden"
              >
        <div class="md:flex w-full">
          <div class="hidden md:block w-full h-full bg-indigo-500 py-10 px-10">
            <svg
