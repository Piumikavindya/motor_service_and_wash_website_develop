...
const DeleteReservation = () => {
  ...
  const handleDeleteReservation = () => {
    setLoading(true);
    axios
      .delete(`http://localhost:5555/reservation/delete/${id}`)
      .then(() => {
        setLoading(false);
                      ...
                      <div className="mt-3 text-center sm:ml-4 sm:mt-0 sm:text-left">
                        ...
                        <div className="mt-2">
                          ...
                          Are you sure want to delete this Item?<br />
                            ...
                            Note : Once you delete this Reservations all details of this reservation
                              of this user will be removed from the
                              system!!{" "}
                            </span>
                          </p>
                        </div>
